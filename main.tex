...
\input{sections/1.logiqueprop.tex}
\newpage
...
\input{sections/2.deductionnaturelle.tex}
\newpage
...
\label{sec:sat}
\input{sections/3.SAT.tex}
\newpage

\section{Automates}
\label{sec:automates}
\input{sections/4.automates.tex}
\newpage

\section{Introduction à la théorie de la complexité}
\label{sec:complexité}
\input{sections/5.complexite.tex}
\newpage
